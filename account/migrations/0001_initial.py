    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('displayname', models.CharField(max_length=14, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Zآابپت-جچح-زژس-غفقکگل-وی۰-۹ ]*$', 'invalid format.')])),
                ('credit', models.IntegerField(default=0)),
                ('image', models.ImageField(blank=True, null=True, upload_to=account.models.profile_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.supportticket')),
            ],
        ),
    ]
